...
export class News extends Component {
    ...
    async componentDidMount() {
        ...
        // search url:- const url = `https://api.currentsapi.services/v1/search/?country=in&keywords=Virat&category=${this.props.category}&apiKey=kDXbsms2DfRmMFpZwAZAjFzyNEqf9BaQ2KqWHqskd8Une1Kk&page_size=100`
